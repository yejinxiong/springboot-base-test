/*
 ...
 Source Schema         : springboot-base-test

 Target Server Type    : MySQL
 Target Server Version : 80027
 File Encoding         : 65001

 Date: 03/02/2023 17:40:45
*/
...
CREATE TABLE `tbl_qm_items`  (
  ...
  `use_flag` tinyint(0) NULL DEFAULT NULL COMMENT '是否已被用作评分：0-未使用 1-已使用',
  `delete_flag` tinyint(0) NULL DEFAULT NULL COMMENT '是否删除：0-否 1-是',
...
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '评分项表' ROW_FORMAT = Dynamic;
